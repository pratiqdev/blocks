        ...
        <section className="flex h-full w-full py-12 @md:py-24  @lg:py-32 @xl:py-48">
            <div className="container px-4 @md:px-6 flex flex-col items-center justify-between @md:flex-row gap-6">
                <div className="text-center @md:text-left">
                    <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl @md:text-5xl text-bks-primary">The Future of Web Development</h1>
                ...
                <Card className="@md:ml-6 min-w-[16rem] border-bks-secondary">
                    <CardHeader>
